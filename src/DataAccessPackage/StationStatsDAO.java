...
public class StationStatsDAO {
    public List<StationBikeNbModel> getBikeCountPerStation() throws DataAccessException {
        ...
        try(PreparedStatement stmt = connection.prepareStatement(query)){
            ...
            throw new DataAccessException("Erreur de récuperation du nombre de vélos par station",e);
        }
